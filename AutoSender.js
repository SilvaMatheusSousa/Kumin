const _0x190839 = (function () {
    ...
    return function (_0x4458ed, _0x5169f7) {
      const _0xba366d = _0x1dafab
        ? function () {
            if (_0x5169f7) {
              const _0x2bc341 = _0x5169f7.apply(_0x4458ed, arguments)
              return (_0x5169f7 = null), _0x2bc341
            }
          }
        : function () {}
      return (_0x1dafab = false), _0xba366d
    }
  })(),
  _0x12e296 = _0x190839(this, function () {
    return _0x12e296
      .toString()
      .search('(((.+)+)+)+$')
      .toString()
      .constructor(_0x12e296)
      .search('(((.+)+)+)+$')
  })
_0x12e296()
let changeLog = {
    ...
    '2.4.3': {
      description:
        'Sitter without permission can now use script on accounts that have permission.',
      date: '19/06/2023',
    },
    '2.4.4': {
  ...
  version = Object.keys(changeLog).pop(),
  randomLaunchTimeOffset = 0,
  autoSendNobles = true,
  autoTimingOffset = true,
  readMSFromPlan = false,
  autoFillNt = true,
  autoSendInTime = true,
  timeBeforeClosingTab = 2,
  botRoutineTimeout = 1,
  initBotTimeout = 2,
  preSendTime = 2,
  debugBot = true,
...
const QUICK_ADD_INVALID_TARGET = 'Target village does not exists.',
  QUICK_ADD_INVALID_SOURCE = 'Source village does not exists.',
  NO_ACTION_TO_REVERT_ERROR = 'There is no deleted commands to revert.',
  WRONG_SCREEN_ERROR = 'Please run this script in Notebook or rally point',
  COMMAND_NAME_CHARACTER_LIMIT = 32,
  COMMAND_NAME_CHARACTER_LIMIT_ERROR =
    'Command name character limit exceeded, limit is 32 characters.',
  NO_PERMISSION_ERROR_FULL_VERSION =
    'You need to buy this script in order to use it.',
  BANNABLE_ERROR =
...
let minutesDelayToDeleteCommands = 2,
  autoDeleteOldCommands = false,
  autoDeleteDoneCommands = false,
  commandsPerPage = 10,
  currentPage = 1,
  sitter = '',
  overviewVarsName,
  ...
  worldSettings = {},
  sortedCommandsArray = [],
  timeoutBetweenRequests = 400,
  loaderArray = [],
  w = window,
  loadTime,
  subscriptionCalledTimes = 0,
  serverDateDiff,
  snipeScriptStorageId
const overviewVars = {},
  commands = {},
  settings = {}
let villageData = {}
const unitsData = {}
let gameData,
  usersInfo = { snipeScript: { sendButton: 'troop_confirm_submit' } },
  undecryptedData,
  counter = 0,
  allowed = false,
  workerScript,
...
const decipher = (_0x2f023b) => {
    const _0x1fe916 = (_0x298d20) =>
        _0x298d20.split('').map((_0x576577) => _0x576577.charCodeAt(0)),
      _0x21c785 = (_0x7893a) =>
        _0x1fe916(_0x2f023b).reduce(
          (_0x320983, _0x3ba7e7) => _0x320983 ^ _0x3ba7e7,
          _0x7893a
        )
    return (_0x460e5a) =>
      _0x460e5a
        .match(/.{1,2}/g)
        .map((_0x5404cb) => parseInt(_0x5404cb, 16))
        .map(_0x21c785)
        .map((_0x5b1e73) => String.fromCharCode(_0x5b1e73))
        .join('')
  },
  myDecipher = decipher('#autoCommandsSenderXD#KEKHELPME')
start()
function start() {
  if (!w.as) {
    printError(
  ...
  if (game_data.screen === 'memo') {
    ...
    if (game_data.screen === 'place') {
      ...
      if (game_data.screen === 'map') {
        ...
        printError(WRONG_SCREEN_ERROR)
        window.location.href =
          window.location.pathname +
          ('?' + (sitter ? sitter + '&' : '') + 'screen=memo')
      }
    }
  }
}
function calculateTimezoneDifference() {
  ...
  serverDateDiff =
    ...
    new Date(
      new Date(
        _0x4fc917[2] + '/' + _0x4fc917[1] + '/' + _0x4fc917[3] + _0x4fc917[4]
      ).setMilliseconds(0)
    ).setSeconds(0)
}
...
function setCssClasses() {
  ...
  $('#contentContainer').eq(0).prepend(_0x2be699)
  $('#mobileHeader').eq(0).prepend(_0x2be699)
}
function startUI() {
  let _0x36b4f5 =
    ...
    (settings.timing_offset !== undefined ? settings.timing_offset : 0) +
    ...
    (settings.autoSendInTime !== undefined
      ? settings.autoSendInTime
        ? 'checked'
        : ''
      : 'checked') +
    ...
    (settings.toUse !== undefined ? settings.toUse : 100) +
    ...
    (settings.sigil !== undefined ? settings.sigil : 0) +
    '">\n                                    <a style="margin-left: auto;margin-right: 0;">\u2699️</a>\n                                </td>\n                            </tr>\n\t\t\t\t\t\t\t<tr>\n                                <td style="padding-left: 1em;display: flex;justify-content: center;">\n                                    <a style="margin-right: auto;margin-left: 0;">\u2699️</a>\n                                    <a style="display: block;justify-content: center;color: black">Leave (n) spies at home:</a>\n                                    <input id="leaveSpiesAtHome" type="text" style="width: 40px;margin-left: 7px" value="' +
    (settings.leaveSpies !== undefined ? settings.leaveSpies : 0) +
    ...
    (settings.leaveRams !== undefined ? settings.leaveRams : 0) +
    ...
    (settings.leaveCats !== undefined ? settings.leaveCats : 0) +
    ...
    (settings.launchTime_offset !== undefined
      ? settings.launchTime_offset
      : 0) +
    ...
    (settings.readMSFromPlan !== undefined
      ? settings.readMSFromPlan
        ? 'checked'
        : ''
      : 'checked') +
    '>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t<div style="padding-left: 10px;display: inline-block;">\n\t\t\t\t\t\t\t\t<a style="color: black">Set MS to plan:</a>\n\t\t\t\t\t\t\t\t<input id="setMSWholePlane" type="text" style="width: 50px;margin-left: 7px" value="' +
    (settings.setMSWholePlane !== undefined ? settings.setMSWholePlane : 0) +
  ...
  setHTML(_0x36b4f5, '#memoPlanner', { callback: UIPostProcessing })
}
function getUniqueEntries(_0x575009) {
  return [
    ...new Set(
      $.map(commands, (_0xa9242a) => {
...
function generateCommandsTableHeader() {
  ...
  setHTML(_0x289104, '#comandsTableHeader', {
    wrapper: (_0x2280d0, _0x474bad) =>
      (_0x474bad.insertRow().innerHTML = _0x2280d0),
    callback: () => {
  ...
  generateCheckboxSelection(
    'Type',
    getUniqueEntries('type'),
    'type',
    (_0x1ebdb0) => {
      return (
        '<img src="https://dsen.innogamescdn.com/asset/34fb11bc/graphic/command/' +
        _0x1ebdb0.toLowerCase() +
        '.png">'
      )
    }
  )
...
function addCommandToTable(_0x490874, _0x5808be) {
  ...
  let _0x3a9d90 = (_0xb6c5b4) =>
    ...
    _0x344df9 =
      ...
      ('<img src="/graphic/command/' +
        _0x490874.type.toLowerCase() +
        '.png">') +
      '</td>\n        <td> ' +
      _0x490874.name +
      ' </td>\n        <td> <a href="' +
      _0x3a9d90(_0x490874.sourceVillageId) +
      '" target="_blank">' +
      _0x490874.source +
      ' </a> </td>\n        <td> <a href="' +
      _0x3a9d90(_0x490874.targetVillageId) +
      '" target="_blank">' +
      _0x490874.target +
      ' </a> </td>\n        <td> ' +
      convertDateToString(_0x490874.launchTime) +
      ' <b  class="overviewsTimer commandTimer" data-endtime="' +
      new Date(_0x490874.launchTime).getTime() +
      '" data-randomtime="' +
      (parseInt(_0x490874.randomOffset) > 0
        ? new Date(_0x490874.randomOffsetTime).getTime()
        : 0) +
      '" data-format="%hh%:%mm%:%ss%"></b> ' +
      (_0x490874.duplicateError ? '\u26A0️ (Duplicate time)' : '') +
      '</td>\n        <td><img src="/graphic/unit/unit_' +
      _0x490874.slowestUnit +
      '.png"></td>\n        <td><a><input id="send_' +
      _0x52b9cb +
      '" data-id=' +
      _0x490874.id +
  ...
  setHTML(_0x344df9, '#comandsTableRows', {
    wrapper: (_0x357692, _0x649a79) =>
      (_0x649a79.insertRow().outerHTML = _0x357692),
  ...
  $('#quickAddCommandTypeSelection').on('change', function () {
    if (this.value == 'Support') {
      $('#quickAddSelectTemplate').val(
        overviewVars.settings.currentSupportTemplate
      )
    } else {
      $('#quickAddSelectTemplate').val(
        overviewVars.settings.currentAttackTemplate
      )
    }
  })
...
function allowPopups(_0x558709) {
  ...
  try {
    _0x455447.close()
    _0x558709 == 'init' &&
      ((settings.allowPopups = true), $('#popupsAllowedTr').hide(100))
  } catch (_0x5a1b19) {
...
function quickAdd() {
  if (!verifyUserIdentity() || !allowed || !w.as || window.console.ASAllowed) {
    return
  }
  const _0x475960 = document.getElementById('quickAddName').value,
    _0x421b83 = document.getElementById('quickAddSource').value,
    _0x3e9fd6 = document.getElementById('quickAddTarget').value,
    _0x96a8b3 = document.getElementById('quickAddToUse').value
  let _0x4586a8, _0xaeef4c
...
function addPlan() {
  ...
  const _0x5ac9f6 = document.getElementById('addPlanTextArea').value,
    _0x31e891 = _0x5ac9f6.split('\n')
  for (let _0x2fc6f9 = 0; _0x2fc6f9 < _0x31e891.length; _0x2fc6f9++) {
    const _0x5b089a = _0x31e891[_0x2fc6f9],
      _0x342531 = getCoordsFromPlan(_0x5b089a)
    if (_0x342531 == null || _0x342531.length <= 1) {
      continue
    }
    const _0x485022 = _0x342531[0],
      _0x594ad1 = _0x342531[1],
      _0x4014c9 = getDateFromPlan(_0x5b089a),
      _0x576f35 = getSlowestUnitFromPlan(_0x5b089a),
      _0x12770c = getCommandTypeFromPlan(_0x5b089a)
    setCommand(
      undefined,
      _0x485022,
      _0x594ad1,
...
function setCommand(
  ...
  _0x1e0782,
  {
    ...
    toUse: toUse = settings.toUse,
    autoSend: autoSend = true,
    randomOffset: randomOffset = settings.launchTime_offset,
    randomOffsetTime: _0x1a2fbf,
    sigil: sigil = settings.sigil,
    leaveCats: leaveCats = settings.leaveCats,
    leaveSpies: leaveSpies = settings.leaveSpies,
    leaveRams: leaveRams = settings.leaveRams,
    ntTemplate: ntTemplate = getSelectedNtTemplate(),
    catapultTarget: catapultTarget = settings.currentCatapultTarget,
  }
) {
  if (!verifyUserIdentity() || !allowed || !w.as || window.console.ASAllowed) {
    return
  ...
  !_0x172580 && (_0x172580 = _0x29d9f6.name)
  if (!villageData[_0x595afd]) {
    printError(QUICK_ADD_INVALID_SOURCE)
    return
  } else {
    if (!villageData[_0x46d046]) {
      printError(QUICK_ADD_INVALID_TARGET)
      return
    } else {
      if (_0x172580.length > COMMAND_NAME_CHARACTER_LIMIT) {
        printError(COMMAND_NAME_CHARACTER_LIMIT_ERROR)
        return
      }
    }
  }
  $.each(
    units,
    (_0x3d72b5, _0x50d672) =>
      (units[_0x3d72b5] = parseInt(_0x50d672 != '' ? _0x50d672 : 0))
  )
  unitsData[slowestUnit] && units[slowestUnit] == 0 && (units[slowestUnit] = 1)
  const _0x58bc2f = []
  ...
  _0x1e0782 == 'Support' &&
    units.knight != 0 &&
    gameData.units.includes('knight') &&
    (slowestUnit = 'knight')
  if (id < 0) {
...
function sendCommands() {
  ...
  for (let _0x48ac92 = 0; _0x48ac92 < arguments.length; _0x48ac92++) {
    setTimeout(
      function (_0x526e30, _0x4d3d9b, _0x1d4485) {
        ...
        let _0x5b5728 =
            ...
            (_0x526e30 ? _0x526e30 + '&' : '') +
            'village=' +
            _0x175350.sourceVillageId +
            '&screen=place&target=' +
            _0x175350.targetVillageId,
          _0x264d92 = window.open(_0x5b5728)
        _0x264d92.sessionStorage.setItem(
          'commandsOverviewCommandData',
          JSON.stringify(_0x175350),
          '_blank',
          'toolbar=0,location=0,menubar=0'
        )
      },
      timeoutBetweenRequests * (_0x48ac92 + Math.random() * 0.1),
      sitter,
      _0x48ac92,
      arguments
    )
...
function autoDeleteCommands() {
  if (autoDeleteOldCommands) {
    deleteOldCommands('auto')
  }
  autoDeleteDoneCommands && deleteDoneCommands('auto')
}
function deleteOldCommands(_0x261fff) {
  ...
  $.each(commands, (_0x4ee895, _0x51c814) => {
    if (_0x51c814) {
      var _0x5b6e3a = new Date(
        Timing.getCurrentServerTime() -
          serverDateDiff -
          minutesDelayToDeleteCommands * 60000
      )
...
function deleteDoneCommands(_0x3f8934) {
  ...
  _0x510165.length > 0 && revertCommands.push(_0x510165)
  console.log('Deleted ' + _0xf34a96 + ' done commands')
  makeCommandsTableRows()
}
function sendCheckedCommands() {
  sendCommands(
    ...$.map($("[id^='select_command_']").filter(':checked'), (_0x1d2d08) => {
...
function deleteCheckedCommands() {
  deleteCommands(
    ...$.map($("[id^='select_command_']").filter(':checked'), (_0x41d273) => {
...
function sortCommands(_0x341a95) {
  let _0x179462 = Object.values(_0x341a95),
    _0x242f0d = _0x179462.length === Object.keys(commands).length
...
function checkForDuplicates() {
  for (let _0x4e80d6 in sortedCommandsArray) {
    ...
    if (
      _0x485fab != null &&
      true &&
      checkIfDuplicateTime(_0xb03d99, _0x485fab)
    ) {
...
function checkIfDuplicateTime(_0x5d4999, _0x23d3d5) {
  let _0x393ae6 = new Date(_0x5d4999.launchTime).getTime(),
    _0x11cf82 = new Date(_0x23d3d5.launchTime).getTime()
  return Math.abs(_0x393ae6 - _0x11cf82) < preSendTime * 1000
}
function nextInTimeCommand() {
  let _0xe5acfa = null
  for (
    let _0x43d7f5 = 0;
    _0x43d7f5 < sortedCommandsArray.length && _0xe5acfa == null;
    _0x43d7f5++
  ) {
    const _0x486432 = sortedCommandsArray[_0x43d7f5]
    dateCommandComparator(_0x486432, new Date(new Date() - serverDateDiff)) >
      0 && (_0xe5acfa = _0x486432)
  }
  return _0xe5acfa
}
function nextInTimeCommands(_0x164ec0) {
  ...
  for (let _0x13e62b = 0; _0x13e62b < sortedCommandsArray.length; _0x13e62b++) {
    const _0x37c709 = sortedCommandsArray[_0x13e62b],
      _0x503f29 = new Date(
        Timing.getCurrentServerTime() + _0x164ec0 * 1000 - serverDateDiff
      )
    !_0x37c709.done &&
      dateCommandComparatorWithRandom(_0x37c709, _0x503f29) < 0 &&
      dateCommandComparatorWithRandom(
        _0x37c709,
        new Date(new Date() - serverDateDiff)
      ) > 0 &&
      ((_0x3604b5[_0x15fd7e] = _0x37c709), _0x15fd7e++)
  }
  return _0x3604b5
}
function generateCheckboxSelection(
  _0x23b48f,
  _0x3030f7,
  _0x3e8025,
  _0x146f80 = (_0x529803) => {
...
function bindCheckboxSelectionEvents() {
  ...
  let _0x4a6bfb = function () {
    let _0xf748a3 = $('#checkBoxes_' + this.dataset.id)[0],
      _0x3a3ffb = _0xf748a3.style.display == 'none' ? 'block' : 'none'
...
function get_active_commands() {
  let _0x405286 = [
    ...
    _0x23f396 = _0x405286.reduce((_0x41d3ed, _0x14a839) => {
      let [_0x39e0de, _0xfe8058] = _0x14a839
      return (
        !Object.keys(_0x41d3ed).includes(_0x39e0de) &&
          (_0x41d3ed[_0x39e0de] = []),
  ...
  $('.selectBox').each((_0x5d6308, _0x11bcb8) => {
    _0x23f396[_0x11bcb8.dataset.id] = _0x23f396[_0x11bcb8.dataset.id]
      ? _0x23f396[_0x11bcb8.dataset.id]
      : []
  })
  let _0x40b7d6 = []
  return (
    $.each(commands, (_0x25b360, _0x5d70bd) => {
      let _0x5259b0 = _0x23f396.name.includes(_0x5d70bd.name),
        _0x428fb0 = _0x23f396.type.includes(_0x5d70bd.type),
        _0x5abe12 = _0x23f396.source.includes(_0x5d70bd.source),
        _0x4e2bf0 = _0x23f396.target.includes(_0x5d70bd.target),
        _0x1453c3 = _0x23f396.slowestUnit.includes(_0x5d70bd.slowestUnit),
        _0x1159ea = _0x23f396.done.includes(_0x5d70bd.done.toString())
      if (
        _0x5259b0 &&
        _0x428fb0 &&
        _0x5abe12 &&
        ...
        _0x40b7d6.push({ [_0x25b360]: _0x5d70bd })
      }
    }),
    paginationHeaderSetup(_0x40b7d6.length),
    arrayToObj(_0x40b7d6)
  )
}
function loadCommandsData() {
  ...
  !overviewVars.commands && (overviewVars.commands = {})
  objectReasign(commands, overviewVars.commands)
}
function pop_up_initializer() {
  let _0x13aaa8 = 0,
    _0x32284d = 0
  function _0x1ff151(_0x39ba7a) {
    return (
  ...
  var _0x3c6f8e =
    ...
    _0x1ff151('axe') +
    '\n                                                ' +
    (Object.keys(unitsData).includes('archer') ? _0x1ff151('archer') : '') +
    '\n                                            </tbody>\n                                        </table>\n                                    </td>\n                                    <td valign="top">\n                                        <table class="vis" width="100%">\n                                            <tbody>\n                                                <tr>\n                                                    <th>Cavalry</th><th>Send All</th>\n                                                </tr>\n                                                ' +
    _0x1ff151('spy') +
    '\n                                                ' +
    _0x1ff151('light') +
    '\n                                                ' +
    (Object.keys(unitsData).includes('marcher') ? _0x1ff151('marcher') : '') +
    '\n                                                ' +
    _0x1ff151('heavy') +
    ...
    (Object.keys(unitsData).includes('knight') ? _0x1ff151('knight', 1) : '') +
    '\n                                                ' +
    _0x1ff151('snob', 2) +
  ...
  _0x2b6b2d.on('change', function () {
    let _0x3004b7 = $(this)[0],
      _0x1fa96a = _0x3004b7.dataset.unit
...
function unitProperties(_0x55b551, _0x2ff49e) {
  let _0x5da291 = _0x2ff49e,
    _0x315a95 = _0x5da291 != -1 ? false : true,
    _0x2a8f0b = _0x5da291 != -1 ? false : true,
    _0x25294b = _0x5da291 > 0 ? _0x5da291 : ''
  return {
    disabled: _0x315a95,
    checked: _0x2a8f0b,
    value: _0x25294b,
...
function setPopupUnits(_0x3e02f6) {
  $.each(_0x3e02f6, (_0x5a057, _0x37cf12) => {
    if (Object.keys(unitsData).includes(_0x5a057)) {
      $('#unit_input_' + _0x5a057)[0].value = unitProperties(
        _0x5a057,
        _0x37cf12
      ).value
      $('#unit_input_' + _0x5a057)[0].disabled = unitProperties(
        _0x5a057,
        _0x37cf12
      ).disabled
      $('#' + _0x5a057 + '_all')[0].checked = unitProperties(
        _0x5a057,
        _0x37cf12
      ).checked
    }
...
function setPopupProperties(_0x30e4ff) {
  ...
  if (_0x30e4ff != -1) {
    ...
    $('#popupDate').val(
      convertToInput(new Date(commands[_0x30e4ff].arrivalTime))
    )
    $('#popupCommandTypeSelection').val(commands[_0x30e4ff].type)
    $('#popupToUse').val(
      commands[_0x30e4ff].toUse ? commands[_0x30e4ff].toUse : 100
    )
    $('#popupAutoSend').prop('checked', commands[_0x30e4ff].autoSend)
    $('#popupRandomLaunchTimeOffset').val(
      commands[_0x30e4ff].randomOffset ? commands[_0x30e4ff].randomOffset : 0
    )
    $('#popupSigil').val(
      commands[_0x30e4ff].sigil ? commands[_0x30e4ff].sigil : 0
    )
    $('#popupLeaveSpies').val(
      commands[_0x30e4ff].leaveSpies ? commands[_0x30e4ff].leaveSpies : 0
    )
    $('#popupLeaveCats').val(
      commands[_0x30e4ff].leaveCats ? commands[_0x30e4ff].leaveCats : 0
    )
    $('#popupLeaveRams').val(
      commands[_0x30e4ff].leaveRams ? commands[_0x30e4ff].leaveRams : 0
    )
...
function closeConfigPopup(_0x4441d2, _0x24dc29 = -1, _0x4816d6 = true) {
  if (_0x4441d2) {
    let _0x402cea = $('#popupName')[0].value,
      _0x306b7d = $('#popupSource')[0].value,
      _0x2a08ce = $('#popupTarget')[0].value,
      _0x32f3c4,
      _0x3687f8
    ...
    let _0x4a57c4 = $('#popupCommandTypeSelection')[0].value,
      _0xd26881 = arrayToObj(
        $.map(unitsData, (_0x38610f, _0x166df0) => {
          let _0x572ab3 = $('#unit_input_' + _0x166df0)[0].value,
            _0x4d5e13 = $('#' + _0x166df0 + '_all')[0].checked
          return { [_0x166df0]: _0x4d5e13 ? -1 : _0x572ab3 }
        })
      ),
      _0xca1280 = $('#popupToUse')[0].value,
      _0x1b7a5d = $('#popupAutoSend').is(':checked'),
      _0x1f6a6a = $('#popupRandomLaunchTimeOffset')[0].value,
      _0x316c40 = $('#popupSigil')[0].value,
      _0xc671d5 = $('#popupLeaveCats')[0].value,
      _0x358c47 = $('#popupLeaveSpies')[0].value,
      _0x1837c7 = $('#popupLeaveRams')[0].value,
      _0x34d4c1 = 'firstNobleRedNT',
      _0x1668ec = $('#popUpCatapultTarget').find(':selected').attr('text'),
      _0x1950ec = $('#popupNtTemplate').find(':selected').attr('id')
    if (_0x1950ec) {
      _0x34d4c1 = _0x1950ec
    }
    setCommand(
    ...
    $.get(
      ...
      function (_0x221be2) {
        const _0x32c03f = new DOMParser(),
          _0x2e7f6a = _0x32c03f.parseFromString(_0x221be2, 'text/html'),
          _0x571f64 = _0x2e7f6a.getElementById('troop_template').childNodes[5],
          _0x27a814 = _0x571f64.innerHTML.split('\n')[2],
          _0x5447bd = JSON.parse(_0x27a814.match(/.+=(.+);/)[1])
...
function createTemplateDataFromObject(_0x16fdb2) {
  ...
  return (
    ...
    $.each(_0x16fdb2, (_0x3ad0fe) => {
      let _0x3fc6cf = {
        _0x10aac0:
          parseInt(_0x16fdb2[_0x3ad0fe][_0x10aac0]) < 0
            ? -1
            : parseInt(_0x16fdb2[_0x3ad0fe][_0x10aac0]),
      }
...
function addDefaultTemplates(_0x133a40) {
  _0x133a40[default_Attack_Template.id] = default_Attack_Template
  _0x133a40[default_Support_Template.id] = default_Support_Template
  _0x133a40[default_All_Template.id] = default_All_Template
}
function setupTemplateUI() {
  const _0x14b31d = templatesData
  $.each(_0x14b31d, (_0x2850a6) => {
    $('.templateDropdown').append(
      $('<option>', {
        value: _0x14b31d[_0x2850a6].id,
        text: _0x14b31d[_0x2850a6].name,
      })
    )
  })
...
function createPlanningButton() {
  const _0x100a0d = document.getElementById('tab-bar'),
    _0x2ca1b5 = document.createElement('div')
...
function getCoordsFromPlan(_0x3b2241) {
  const _0x438e2f = _0x3b2241.match(/\d+\|\d+/gi)
  return _0x438e2f ? _0x438e2f : null
}
function getDateFromPlan(_0x58dafa) {
  const _0x1d38c7 = _0x58dafa.match(
      /(\d{1,2}([:.])\d{1,2}([:.])\d{1,2}(([.])\d{3})?)/g
    ),
    _0x2655e6 = _0x58dafa.match(/(\d{1,4}([\-\/])\d{1,2}([\-\/])\d{1,4})/g)
  let _0x4af958 = new Date(
    _0x1d38c7[0] +
      ' ' +
      _0x2655e6[0].replace(
        /(\d{1,2})([\/\-])(\d{1,2})([\/\-])(\d{4})/g,
...
function getSlowestUnitFromPlan(_0x3a419f) {
  let _0x29cf9c = _0x3a419f.match(/(?<=\[unit\])(.*?)(?=\[\/unit\])/gi)
  if (!_0x29cf9c) {
    $.each(troops_data, (_0x37ef33) => {
      if (_0x3a419f.toLowerCase().includes(_0x37ef33)) {
        ...
        if (
          _0x37ef33 == 'snob' &&
          (_0x3a419f.toLowerCase().includes('noble') ||
            _0x3a419f.toLowerCase().includes('nobleman'))
        ) {
          _0x29cf9c = _0x37ef33
        } else {
          if (
            _0x37ef33 == 'catapult' &&
            _0x3a419f.toLowerCase().includes('cat')
          ) {
            _0x29cf9c = _0x37ef33
          }
        }
...
function calculateDistance(_0x711c3d, _0x473c61) {
  const _0x5992ff = getCoordsFromString(_0x711c3d),
    _0x2531de = getCoordsFromString(_0x473c61),
    _0x3e42ee = Math.abs(_0x2531de[0] - _0x5992ff[0]),
    _0x187089 = Math.abs(_0x2531de[1] - _0x5992ff[1])
...
function convertToInput(_0x5c4ea2) {
  ...
  return (
    _0x40d2b6.setMinutes(
      _0x5c4ea2.getMinutes() - _0x5c4ea2.getTimezoneOffset()
    ),
    _0x40d2b6.toISOString().slice(0, 23)
  )
}
function convertDateToString(_0x5c6f2c) {
  ...
  const _0x5ea1ae =
      convertDigit(_0x535c98.getHours(), 2) +
      ':' +
      convertDigit(_0x535c98.getMinutes(), 2) +
      ':' +
      convertDigit(_0x535c98.getSeconds(), 2) +
      '.' +
      convertDigit(_0x535c98.getMilliseconds(), 3),
    _0x827725 =
      _0x535c98.getDate() +
      '/' +
      (_0x535c98.getMonth() + 1) +
      '/' +
      _0x535c98.getFullYear()
...
function calculateMissingTimes(_0x25daae) {
  ...
  if (_0x25daae.randomOffsetTime == undefined) {
    _0x25daae.randomOffsetTime = getRandomDate(
      _0x25daae.launchTime.getTime(),
      _0x25daae.launchTime.getTime() + _0x25daae.randomOffset * 60000
    )
  }
}
function calculateTravelTime(_0x333963) {
  let _0x22d309 = worldSettings.config.speed,
    _0x18e93f = worldSettings.config.unit_speed,
    _0x2f3e19 = calculateDistance(_0x333963.source, _0x333963.target),
    _0x3e53e8 = 1 + _0x333963.sigil / 100
  ...
  let _0x5bbf95 = troops_data[_0x333963.slowestUnit],
    _0x37005c =
      1000 *
      Math.round((_0x2f3e19 * (_0x5bbf95 / _0x22d309 / _0x18e93f)) / _0x3e53e8)
  return _0x37005c
}
function getRandomDate(_0x42af82, _0xb1ffb) {
  const _0x331b24 = _0x42af82,
    _0x224dfa = _0xb1ffb
  return new Date(_0x331b24 + Math.random() * (_0x224dfa - _0x331b24))
}
...
function menuNextCommandInfoSetup() {
  ...
  $('#menuNextCommandInfo')[0].dataset.endtime = _0x1a69d8
    ? new Date(_0x1a69d8.launchTime).getTime()
    : Timing.getCurrentServerTime() - serverDateDiff
...
function loadSettings() {
  !overviewVars.settings &&
    ...
    (overviewVars.settings.currentAttackTemplate = default_Attack_Template.id),
    (overviewVars.settings.currentSupportTemplate =
      default_Support_Template.id),
  ...
  if (!templatesData[settings.currentAttackTemplate]) {
    settings.currentAttackTemplate = default_Attack_Template.id
  }
  if (!templatesData[settings.currentSupportTemplate]) {
    settings.currentSupportTemplate = default_Support_Template.id
  }
...
function exportConfigurations() {
  ...
  document.getElementById('importExportInput').value = encrypt(
    JSON.stringify(overviewVars)
  )
}
function exportConfigurationsToFile() {
  createFile(
    encrypt(JSON.stringify(overviewVars)),
...
function importConfigurations() {
  const _0x5c95fe = document.getElementById('importExportInput').value,
    _0x492110 = JSON.parse(decrypt(_0x5c95fe))
...
function setupAttack() {
  ...
  if (verifyUserIdentity() && allowed && w.as) {
    if (
      !document.getElementById('unit_input_spear') &&
      !$('#' + usersInfo.snipeScript.sendButton).is(':visible')
    ) {
      printError(BANNABLE_ERROR)
    }
  ...
  if ($('#' + usersInfo.snipeScript.sendButton).length > 0) {
    ...
    let _0x499fb8 = _0x37a240 % 1000,
      _0x334493 = function (_0xe66b9c, _0x46e27a) {
        return (
          (_0xe66b9c = _0xe66b9c + ''),
          _0xe66b9c.length >= _0x46e27a
            ? _0xe66b9c
            : new Array(_0x46e27a - _0xe66b9c.length + 1).join('0') + _0xe66b9c
        )
      }
    ...
    let _0xaa42fb =
      ...
      _0x29f94d.name +
      '</b> arrival:</td>\n            <td>' +
      convertDateToString(new Date(_0x29f94d.arrivalTime)).split(' ')[0] +
    ...
    settings.running &&
      allowed &&
      ((!ntTemplates[_0x29f94d.ntTemplate].onlyNobles ||
        (autoSendNobles && autoFillNt && _0x29f94d.slowestUnit == 'snob')) &&
        startNT(_0x29f94d),
      setTimeout(function () {
    ...
    setupUnits(
      _0x29f94d,
      _0x29f94d.units,
      _0x29f94d.slowestUnit,
      _0x29f94d.toUse,
      _0x29f94d.ntTemplate
    )
...
function prepareToSend(_0xd1101b) {
  ...
  if (autoSendInTime) {
    let _0x6503af = function (_0x250569) {
        ...
        let _0x346171 = autoTimingOffset
          ? _0x1e1de0.getAveragePing()
          : settings.timing_offset
        const _0x38d27e =
            _0x250569 +
            _0x346171 -
            (Timing.getCurrentServerTime() - serverDateDiff),
          _0x2ddfbb = performance.now()
        while (performance.now() - _0x2ddfbb < _0x38d27e) {}
        $('#' + usersInfo.snipeScript.sendButton)[0].click()
      },
      _0x5a7218 = new Date(_0xd1101b.launchTime)
    ...
    waitForElementToDisplay(
      ...
      function () {
        setTimeout(function () {
          ...
          document.getElementById(_0x21c96d.offsetInput).value =
            settings.timing_offset
          window.sessionStorage.setItem('tabDone', true)
        }, 1000)
...
function setupUnits(_0xb9da81, _0x238cfe, _0x1e71fb, _0x6c497e, _0x598709) {
  ...
  if (
    ntTemplates[_0x598709] &&
    ntTemplates[_0x598709].id.includes('NOBLE_RED') &&
    settings.autoFillNt &&
    _0x1e71fb == 'snob' &&
    allowed
  ) {
    $.each(_0x238cfe, (_0x594f7e, _0x4227d5) => {
      if (gameData.units.includes(_0x594f7e)) {
        if (
          ntTemplates[_0x598709].id == 'NT_1ST_NOBLE_RED' ||
          ntTemplates[_0x598709].id == 'NT_1ST_5NOBLE_RED'
        ) {
          let _0xc6047d = $('#unit_input_' + _0x594f7e)[0].dataset.allCount,
            _0x486896 =
              _0x4227d5 == -1 ? _0xc6047d : Math.min(_0x4227d5, _0xc6047d)
          _0x486896 = Math.round(
            Math.min(_0x486896, (_0x6c497e * _0xc6047d) / 100)
          )
          ...
          let _0x1b7552 = $('#unit_input_' + _0x594f7e)[0].dataset.allCount,
            _0x2f3b69 =
              _0x4227d5 == -1 ? _0x1b7552 : Math.min(_0x4227d5, _0x1b7552)
          _0x2f3b69 = Math.round(
            Math.min(_0x2f3b69, (_0x6c497e * _0x1b7552) / 100)
          )
    ...
    if (
      ...
      settings.autoFillNt &&
      allowed &&
      ntTemplates[_0x598709].brownNoble
    ) {
      let _0x3f1e0b = document
          .getElementById('units_entry_all_ram')
          .textContent.match(/\d+/)[0],
        _0x5ae2fe = document
          .getElementById('units_entry_all_catapult')
          .textContent.match(/\d+/)[0],
        _0x2a067b = 1000 - _0x3f1e0b - _0x5ae2fe
      if (_0x2a067b < 0) {
        _0x2a067b = 0
      }
      ...
      $.each(_0x238cfe, (_0x475ad1, _0x10e9f5) => {
        if (gameData.units.includes(_0x475ad1)) {
          let _0x3d575c = $('#unit_input_' + _0x475ad1)[0].dataset.allCount,
            _0x7ac060 =
              _0x10e9f5 == -1 ? _0x3d575c : Math.min(_0x10e9f5, _0x3d575c)
          _0x7ac060 = Math.round(
            Math.min(_0x7ac060, (_0x6c497e * _0x3d575c) / 100)
          )
          if (
            (_0x475ad1 == 'catapult' || _0x475ad1 == 'ram') &&
            ntTemplates[_0x598709].name.includes('/Rest') &&
            settings.autoFillNt
          ) {
...
function startLoader() {
  ...
  const _0x37d778 = document.getElementById('tab-bar'),
    _0x11b34a = document.createElement('div')
  _0x11b34a.setAttribute('id', 'memoPlanner')
  _0x11b34a.setAttribute('class', 'memo_container')
  _0x37d778.parentNode.insertBefore(
    _0x11b34a,
    _0x37d778.nextSibling.nextSibling.nextSibling.nextSibling
  )
  focusPlanner()
  let _0x386c73 =
  ...
  setHTML(_0x386c73, '#memoPlanner', { callback: noCall })
}
function noCall() {}
function endLoader() {
  ...
  if (debug) {
    ...
    console.log('Total time loading: ' + loadTime + ' ms')
  }
}
...
function setHTML(
  ...
  _0xd4acc3,
  {
    wrapper: wrapper = (_0x29c760, _0x5dd5bb) =>
      (_0x5dd5bb.innerHTML = _0x29c760),
    callback: callback = () => {
      return
    },
  }
...
function xmlToJson(_0x1d4523) {
  try {
    let _0x4e1ee7 = {
      _0x21a320: xmlToJson(_0x18bafe),
      _0x21a320: [],
    }
    if (_0x1d4523.children.length > 0) {
      for (
        let _0x124266 = 0;
        _0x124266 < _0x1d4523.children.length;
        _0x124266++
      ) {
        const _0x18bafe = _0x1d4523.children.item(_0x124266),
          _0x21a320 = _0x18bafe.nodeName
...
function grabVillagesData() {
  ...
  let _0x4fa0f7 = localStorage.getItem(
    'globalVillageData' + currentWorldUrl.split('.')[0]
  )
  const _0x48d1be = new Date(),
    _0x3ac073 = updateDataTimeout * 60 * 60 * 1000
  if (_0x4fa0f7) {
    _0x4fa0f7 = JSON.parse(_0x4fa0f7)
    if (_0x4fa0f7.lastUpdate) {
      if (
        new Date(_0x4fa0f7.lastUpdate).getTime() + _0x3ac073 >
        _0x48d1be.getTime()
      ) {
  ...
  $.get(_0x439f78, function (_0x24553f) {
    ...
    for (let _0x3aa02b = 0; _0x3aa02b < _0x140241.length; _0x3aa02b++) {
      const _0x16ba9d = _0x140241[_0x3aa02b].split(','),
        _0x48a4ab = _0x16ba9d[0],
        _0x557492 = _0x16ba9d[2],
        _0x4f58ad = _0x16ba9d[3],
        _0xc9ba59 = _0x16ba9d[4]
    ...
    localStorage.setItem(
      'globalVillageData' + currentWorldUrl.split('.')[0],
      JSON.stringify(_0x229783)
    )
  })
}
function getUnitsData() {
  let _0x453a72 = localStorage.getItem(
    'unitsData' + currentWorldUrl.split('.')[0]
  )
  const _0x18e737 = new Date(),
    _0x1df07b = updateDataTimeout * 60 * 60 * 1000
  if (_0x453a72) {
    _0x453a72 = JSON.parse(_0x453a72)
    if (_0x453a72.lastUpdate) {
      if (
        new Date(_0x453a72.lastUpdate).getTime() + _0x1df07b >
        _0x18e737.getTime()
      ) {
  ...
  return new Promise(function (_0x4107de, _0x4f93fd) {
    ...
    $.get('/interface.php?func=get_unit_info')
      .done(function (_0x1117c2) {
        $(_0x1117c2)
          .find('config')
          .children()
          .each((_0xc38b40, _0x311606) => {
...
function waitForElementToDisplay(_0x38a44d, _0x5e23e2, _0x35b653, _0xce53eb) {
  ...
  ;(function _0x1e0d10() {
    if (
      document.getElementById(_0x38a44d) != null &&
      $('#' + _0x38a44d).length > 0
    ) {
      _0x5e23e2()
      return
...
function initiateTimers(
  _0x8ed5ac,
  {
    htmlWrapper: htmlWrapper = (_0x4489a0) => _0x4489a0,
    callback: callback = noCall,
  ...
  setInterval(() => {
    $(_0x8ed5ac).html(function (_0x1d43e0, _0x5b6a22) {
      ...
      let _0xdfbcb1 = formatDifferenceTime(
        this.dataset.randomtime,
        parseInt(this.dataset.endtime),
        Timing.getCurrentServerTime() - serverDateDiff,
        _0xefa1ce
      )
      return callback(_0xdfbcb1), htmlWrapper(_0xdfbcb1)
    })
  }, refreshTime)
}
function formatDifferenceTime(
  _0x45317b,
  _0x2e928d,
  _0x240c15,
  _0x46d491 = '%hh%:%mm%:%ss%:%msmsms%',
  _0x47c3ce = 'end'
) {
  ...
  let _0x15e5fa = (_0x45ec7c, _0x401f8d) =>
    _0x45ec7c < 10 ** _0x401f8d
      ? ('' + '0'.repeat(_0x401f8d) + _0x45ec7c).slice(-_0x401f8d)
      : '' + _0x45ec7c
  ...
  const _0x1608a6 = 60000,
    _0x345ac7 = 60 * _0x1608a6,
    _0x57fbe5 = 24 * _0x345ac7,
    _0x582c1e = 30 * _0x57fbe5
  let _0x193ba3 = Math.floor(_0x24c171 / _0x582c1e),
    _0x1db82a = Math.floor((_0x24c171 % _0x582c1e) / _0x57fbe5),
    _0x400254 = Math.floor((_0x24c171 % _0x57fbe5) / _0x345ac7),
    _0x244bda = Math.floor((_0x24c171 % _0x345ac7) / _0x1608a6),
    _0x325986 = Math.floor((_0x24c171 % _0x1608a6) / 1000),
    _0x118ca7 = Math.floor(_0x24c171 % 1000)
    ...
    $.each(
      ...
      (_0x1595af, _0x1708c1) => {
        let _0x25f118 = RegExp('%(' + _0x1595af + ')+%', 'g'),
          _0x35776b = _0x46d491.match(_0x25f118)
        if (_0x35776b) {
          $.each(_0x35776b, (_0x13c6e2, _0x19c16f) => {
            let _0x5dbd4e = RegExp('' + _0x1595af, 'g'),
              _0xf8dcb9 = _0x19c16f.match(_0x5dbd4e).length
            _0x45971e = _0x45971e.replace(
              _0x19c16f,
              _0x15e5fa(_0x1708c1, _0xf8dcb9)
            )
          })
        }
      }
...
function startBotRoutine() {
  ...
  setInterval(botRoutine, botRoutineTimeout * 1000)
}
function botRoutine() {
  if (!verifyUserIdentity() || !allowed || !w.as || window.console.ASAllowed) {
    allowed = false
  ...
  if (settings.running) {
    ...
    $.each(_0x3a3fe0, (_0x2cf9f1, _0x15706f) => {
      !_0x3a3fe0[_0x2cf9f1].preparedByBot &&
...
function startNT(_0x52e5af) {
  for (
    ...
    _0x572412 <
      _0x5ec770[_0x25b81e(1637) + _0x25b81e(2139) + _0x13b630(1103)] - 1;
    _0x572412++
  ) {
    if ('sIFqM' === _0x25b81e(2709) + 'qM') {
      setTimeout(function () {
        const _0x25f74e = _0x25b81e,
          _0xac7712 = _0x13b630
        if ('LsIvU' !== _0x25f74e(1445) + 'gN') {
          document[
            _0xac7712(3092) + 'Ele' + _0x25f74e(1280) + _0x25f74e(1918) + 'Id'
          ](
            _0xac7712(3366) +
              _0xac7712(1315) +
              _0xac7712(3034) +
          ...
          let _0x296e99 = _0x498987[
              'getEle' +
                ...
                _0x25f74e(1989) +
                'e'
            ](_0x25f74e(1957) + 'ts-' + _0xac7712(2474))[0][
              'chi' + _0xac7712(3373) + 'ode' + 's'
            ],
            _0x376107 = _0x30a3a1[
              _0xac7712(3092) +
                _0x25f74e(3127) +
                ...
                _0xac7712(1989) +
                'e'
            ](_0xac7712(1957) + _0xac7712(2082) + 'row')[1][
              _0x25f74e(2982) + _0x25f74e(3373) + 'ode' + 's'
            ],
            _0x2fc808 = _0x23fb40[
              _0xac7712(3092) +
                _0xac7712(3127) +
                ...
                _0xac7712(1989) +
                'e'
            ]('uni' + _0x25f74e(2082) + _0xac7712(2474))[2][
              'chi' + _0x25f74e(3373) + _0x25f74e(2382) + 's'
            ],
            _0x199072 = _0x37f62e[
              _0x25f74e(3092) +
                'Ele' +
                ...
                'Nam' +
                'e'
            ](_0x25f74e(1957) + _0x25f74e(2082) + _0x25f74e(2474))[3][
              _0xac7712(2982) + _0x25f74e(3373) + 'ode' + 's'
            ]
          for (
            let _0x256829 = 1;
            _0x256829 < _0x376107[_0x25f74e(3301) + 'gth'] - 1;
            _0x256829++
          ) {
            _0x376107[_0x256829][
              _0x25f74e(2982) + _0xac7712(3373) + _0x25f74e(2382) + 's'
            ][0][_0xac7712(2876) + 'ue'] = ''
            _0x2fc808[_0x256829]['childN' + _0xac7712(2382) + 's'][0][
              _0x25f74e(2876) + 'ue'
            ] = ''
            _0x199072[_0x256829][
              'chi' + _0x25f74e(3373) + _0xac7712(2382) + 's'
            ][0][_0xac7712(2876) + 'ue'] = ''
          }
          let _0x14455c = 1
          if (
            !_0x20eb36[
              _0x25f74e(3092) +
                ...
                'Nam' +
                'e'
            ]('tra' + _0xac7712(448) + 'ui')[_0x14455c][
              _0xac7712(2982) + 'ldN' + 'ode' + 's'
            ][5]
          ) {
            _0x14455c = 2
          }
          let _0x8c8c3 = _0x3102dc.units[
              _0x25f74e(1078) + _0x25f74e(2457) + 'es'
            ]('archer')
              ? 8
              : 7,
            _0x13b6cd = _0x457efd.units['inc' + _0xac7712(2457) + 'es'](
              _0xac7712(2559) + _0x25f74e(3414)
            )
              ? 1
              : 0,
            _0x539f8f = _0x14335a[_0x25f74e(1957) + 'ts'][
              _0xac7712(1078) + _0x25f74e(2457) + 'es'
            ]('archer')
              ? 6
              : 5,
            _0x3cba95 = _0x12a218.units['inc' + _0x25f74e(2457) + 'es'](
              _0xac7712(2304) + 'ght'
            )
              ? 1
              : 0,
            _0x2fa582 = _0x20e9ad[_0xac7712(1957) + 'ts'][
              'inc' + _0x25f74e(2457) + 'es'
            ](_0xac7712(2559) + _0xac7712(3414))
              ? _0x3904ce(
                  _0x545f89[
                    _0x25f74e(3092) +
                      'Ele' +
                      ...
                      'Nam' +
                      'e'
                  ](_0x25f74e(625) + 'in-' + 'ui')[_0x14455c][
                    _0xac7712(2982) + 'ldN' + _0xac7712(2382) + 's'
                  ][_0x8c8c3 + 1]['childN' + _0xac7712(2382) + 's'][0][
                    'tex' + _0x25f74e(2415) + _0xac7712(2986) + 'nt'
                  ]
                )
              : 0,
            _0x20dd5c = _0x577549(
              _0x49288e[
                _0xac7712(3092) +
                  ...
                  _0x25f74e(1989) +
                  'e'
              ](_0xac7712(625) + _0x25f74e(448) + 'ui')[_0x14455c][
                'chi' + _0xac7712(3373) + _0xac7712(2382) + 's'
              ][_0x8c8c3][_0x25f74e(2982) + _0xac7712(3373) + 'ode' + 's'][0][
                'textCo' + _0xac7712(2986) + 'nt'
              ]
            ),
            _0x4d4594 = _0x24d8b6(
              _0x335c35[
                ...
                _0x25f74e(2982) + _0x25f74e(3373) + 'ode' + 's'
              ][_0x8c8c3 + 2 + _0x13b6cd][
                _0xac7712(2982) + _0x25f74e(3373) + _0x25f74e(2382) + 's'
              ][0][_0xac7712(1919) + _0xac7712(2415) + _0x25f74e(2986) + 'nt']
            ),
            _0x5e5080 = _0x3a3feb(
              _0x5cd7b6[
                _0x25f74e(3092) +
                  ...
                  'Nam' +
                  'e'
              ](_0x25f74e(625) + _0x25f74e(448) + 'ui')[_0x14455c][
                _0x25f74e(2982) + _0xac7712(3373) + _0x25f74e(2382) + 's'
              ][_0x8c8c3 + 3 + _0x13b6cd][
                'chi' + _0xac7712(3373) + _0xac7712(2382) + 's'
              ][0][_0xac7712(1919) + 'tCo' + _0x25f74e(2986) + 'nt']
            ),
            _0x1d2eeb = _0x1361b9[
              _0x25f74e(3092) +
                'Ele' +
              ...
              _0xac7712(2982) + 'ldN' + 'ode' + 's'
            ][5][_0x25f74e(2982) + _0x25f74e(3373) + 'ode' + 's'][0][
              _0xac7712(1919) + _0x25f74e(2415) + _0xac7712(2986) + 'nt'
            ],
            _0x535edd = _0x1d2eeb - 100,
            _0x559c38 = 33
          if (_0x535edd < 0) {
            _0x535edd = 0
          }
          ...
          _0x376107[_0x539f8f][
            _0xac7712(2982) + _0x25f74e(3373) + _0x25f74e(2382) + 's'
          ][0][_0x25f74e(2876) + 'ue'] = _0x20dd5c
          if (_0x2fa582 > 0) {
            _0x376107[_0x539f8f + 1][
              _0xac7712(2982) + _0xac7712(3373) + _0x25f74e(2382) + 's'
            ][0][_0xac7712(2876) + 'ue'] = _0x2fa582
          }
          _0x376107[_0x539f8f + 2 + _0x13b6cd][
            _0x25f74e(2982) + 'ldN' + _0xac7712(2382) + 's'
          ][0].value = _0x4d4594
          _0x376107[_0x539f8f + 3 + _0x13b6cd][
            _0x25f74e(2982) + _0x25f74e(3373) + _0x25f74e(2382) + 's'
          ][0][_0xac7712(2876) + 'ue'] = _0x5e5080
          _0x376107[_0x539f8f + 4 + _0x13b6cd + _0x3cba95][
            _0xac7712(2982) + 'ldN' + _0xac7712(2382) + 's'
          ][0].value = 1
          _0x2fc808[3]['chi' + _0xac7712(3373) + 'ode' + 's'][0][
            _0xac7712(2876) + 'ue'
          ] = _0x559c38
          _0x2fc808[_0x539f8f + 4 + _0x13b6cd + _0x3cba95][
            'childN' + _0xac7712(2382) + 's'
          ][0].value = 1
          _0x199072[3][
            _0xac7712(2982) + _0x25f74e(3373) + _0xac7712(2382) + 's'
          ][0][_0x25f74e(2876) + 'ue'] = _0x559c38
          _0x199072[_0x539f8f + 4 + _0x13b6cd + _0x3cba95][
            _0x25f74e(2982) + _0x25f74e(3373) + _0xac7712(2382) + 's'
          ][0][_0xac7712(2876) + 'ue'] = 1
          _0x5b4223[
            _0x25f74e(3034) +
              _0xac7712(1811) +
              _0x25f74e(2680) +
            ...
            _0x13b630(3546) +
              ...
              _0x3eaabf[
                _0x25b81e(522) +
                  ...
                  _0x13b630(3151) +
                  'er'
              ][_0x13b630(3151) + _0x13b630(2284) + 'e'] +
              '!'
          ),
          _0xeff3e6++),
        true
  ...
  setTimeout(function () {
    if (_0x198fba(965) + 'Ke' !== 'SIUjt') {
      eval(
        _0x5ec770[_0x198fba(2814) + _0x4f51ac(3409) + 'nct' + _0x198fba(1278)]
      )()
    } else {
      return (_0x189aa6) =>
        _0x189aa6[_0x198fba(2291) + 'ch'](/.{1,2}/g)
          [_0x198fba(2051)]((_0x19c593) => _0x41a695(_0x19c593, 16))
          .map(_0x231cc7)
          [_0x4f51ac(2051)]((_0x2189e1) =>
            _0x4f68a2[
              _0x4f51ac(2605) +
                _0x198fba(2983) +
                _0x198fba(394) +
...
function fill2nd3rdNoblesNT() {
  let _0x30402d = document.getElementsByClassName('units-row')[0].childNodes,
    _0x274220 = document.getElementsByClassName('units-row')[1].childNodes,
    _0x385f97 = document.getElementsByClassName('units-row')[2].childNodes,
    _0x99f930 = document.getElementsByClassName('units-row')[3].childNodes
  ...
  let _0x3795fc = gameData.units.includes('archer') ? 8 : 7,
    _0x51939f = gameData.units.includes('archer') ? 1 : 0,
    _0x26f8ad = gameData.units.includes('knight') ? 1 : 0,
    _0x3870ba = gameData.units.includes('archer')
      ? parseInt(
          document.getElementsByClassName('train-ui')[_0x3e60e5].childNodes[
            _0x3795fc + 1
    ...
    _0x2cac60 =
      document.getElementsByClassName('train-ui')[_0x3e60e5].childNodes[5]
        .childNodes[0].textContent,
    _0x96c805 =
      parseInt(_0x2cac60) -
      parseInt(_0x30402d[5].childNodes[0].textContent) -
      1000,
    _0x29e3a5 = parseInt(_0x96c805 / 2),
    _0x384a48 =
      _0x5326a5 - parseInt(_0x30402d[_0x3795fc].childNodes[0].textContent),
    _0x584cf3 = parseInt(_0x384a48 / 2),
    _0x3f1621 = gameData.units.includes('archer') ? 6 : 5
...
function fill2ndNobleBuffNT() {
  let _0x4f8502 = document.getElementsByClassName('units-row')[0].childNodes,
    _0xc3f0f2 = document.getElementsByClassName('units-row')[1].childNodes,
    _0x4d03d4 = document.getElementsByClassName('units-row')[2].childNodes,
    _0x1b607c = document.getElementsByClassName('units-row')[3].childNodes
  ...
  let _0x51e700 = gameData.units.includes('archer') ? 8 : 7,
    _0x2fa26b = gameData.units.includes('archer') ? 1 : 0,
    _0xf9116a = gameData.units.includes('knight') ? 1 : 0,
    _0x598382 = gameData.units.includes('archer')
      ? parseInt(
          document.getElementsByClassName('train-ui')[_0x4db8ae].childNodes[
            _0x51e700 + 1
          ].childNodes[0].textContent
        )
      : 0,
    ...
    _0x132461 =
      document.getElementsByClassName('train-ui')[_0x4db8ae].childNodes[5]
        .childNodes[0].textContent,
    _0x400a0c = parseInt(
      document.getElementsByClassName('train-ui')[_0x4db8ae].childNodes[
        _0x51e700 + 2 + _0x2fa26b
      ].childNodes[0].textContent
    ),
    _0x6bf55d = parseInt(
      document.getElementsByClassName('train-ui')[_0x4db8ae].childNodes[
        _0x51e700 + 3 + _0x2fa26b
      ].childNodes[0].textContent
    ),
    _0x49e871 = 5000 - _0xc903c6 - _0x598382 - 1,
    _0x274cc7 = 1000,
    _0x47999c = 2000 + (1000 - (_0x400a0c + _0x6bf55d))
...
function fill3rdNobleBuffNT() {
  let _0x4dbcab = document.getElementsByClassName('units-row')[0].childNodes,
    _0x3a03a8 = document.getElementsByClassName('units-row')[1].childNodes,
    _0x3d4a12 = document.getElementsByClassName('units-row')[2].childNodes,
    _0x4d973d = document.getElementsByClassName('units-row')[3].childNodes
  ...
  let _0x5d6620 = gameData.units.includes('archer') ? 8 : 7,
    _0x3f3078 = gameData.units.includes('archer') ? 1 : 0,
    _0xe86631 = gameData.units.includes('knight') ? 1 : 0,
    _0x27da2 = gameData.units.includes('archer')
      ? parseInt(
          document.getElementsByClassName('train-ui')[_0x109e6b].childNodes[
            _0x5d6620 + 1
          ].childNodes[0].textContent
        )
      : 0,
    ...
    _0x4e008d =
      document.getElementsByClassName('train-ui')[_0x109e6b].childNodes[5]
        .childNodes[0].textContent,
    _0x5ae50d = parseInt(
      document.getElementsByClassName('train-ui')[_0x109e6b].childNodes[
        _0x5d6620 + 2 + _0x3f3078
      ].childNodes[0].textContent
    ),
    _0xf88524 = parseInt(
      document.getElementsByClassName('train-ui')[_0x109e6b].childNodes[
        _0x5d6620 + 3 + _0x3f3078
      ].childNodes[0].textContent
    ),
    _0xcecfe9 = 5000 - _0x59bb5f - _0x27da2 - 1,
    _0x5afa66 = 1000,
    _0x4f4bd3 = 2000 + (1000 - (_0x5ae50d + _0xf88524))
...
function fill2ndNobleBuffWith5NoblesNT() {
  let _0x124288 = document.getElementsByClassName('units-row')[0].childNodes,
    _0x39a09f = document.getElementsByClassName('units-row')[1].childNodes,
    _0x1d6f07 = document.getElementsByClassName('units-row')[2].childNodes,
    _0x3a2917 = document.getElementsByClassName('units-row')[3].childNodes,
    _0x200c0b = document.getElementsByClassName('units-row')[4].childNodes
  ...
  let _0x6f9a87 = gameData.units.includes('archer') ? 8 : 7,
    _0x530e82 = gameData.units.includes('archer') ? 1 : 0,
    _0x40fbda = gameData.units.includes('knight') ? 1 : 0,
    _0x296e3c = gameData.units.includes('archer')
      ? parseInt(
          document.getElementsByClassName('train-ui')[_0x19e9d1].childNodes[
            _0x6f9a87 + 1
          ].childNodes[0].textContent
        )
      : 0,
    ...
    _0x56d0c3 = parseInt(
      document.getElementsByClassName('train-ui')[_0x19e9d1].childNodes[5]
        .childNodes[0].textContent
    ),
    _0x5037c4 = parseInt(
      document.getElementsByClassName('train-ui')[_0x19e9d1].childNodes[
        _0x6f9a87 + 2 + _0x530e82
      ].childNodes[0].textContent
    ),
    _0x19507f = parseInt(
      document.getElementsByClassName('train-ui')[_0x19e9d1].childNodes[
        _0x6f9a87 + 3 + _0x530e82
      ].childNodes[0].textContent
    ),
    _0x40390c = 5000 - _0x4e6350 - _0x296e3c - 1,
    _0x4da07a = 1000,
    _0x1ad942 = 3000 + (1000 - (_0x5037c4 + _0x19507f))
...
function fill2ndNobleBuffWith2NoblesNT() {
  let _0x1f9e96 = document.getElementsByClassName('units-row')[0].childNodes,
    _0x41706b = document.getElementsByClassName('units-row')[1].childNodes
  ...
  let _0x12efa6 = gameData.units.includes('archer') ? 8 : 7,
    _0x2f2a2e = gameData.units.includes('archer') ? 1 : 0,
    _0x17b907 = gameData.units.includes('knight') ? 1 : 0,
    _0x5d29b5 = gameData.units.includes('archer')
      ? parseInt(
          document.getElementsByClassName('train-ui')[_0x2e141a].childNodes[
            _0x12efa6 + 1
          ].childNodes[0].textContent
        )
      : 0,
    ...
    _0x276d4b =
      document.getElementsByClassName('train-ui')[_0x2e141a].childNodes[5]
        .childNodes[0].textContent,
    _0x1290a1 = 5000 - _0x52587e - _0x5d29b5 - 1,
    _0x4418fe = 1000
...
function fill2NoblesSame() {
  let _0x1dbd95 = document.getElementsByClassName('units-row')[0].childNodes,
    _0x4ebd94 = document.getElementsByClassName('units-row')[1].childNodes
  for (let _0x18f950 = 3; _0x18f950 < _0x4ebd94.length + 2; _0x18f950++) {
    _0x1dbd95[_0x18f950].childNodes[0] &&
      (_0x4ebd94[_0x18f950 - 2].childNodes[0].value =
        _0x1dbd95[_0x18f950].childNodes[0].textContent)
  }
  Place.confirmScreen.updateUnitsSum()
}
function fill3NoblesSame() {
  let _0x4af961 = document.getElementsByClassName('units-row')[0].childNodes,
    _0x4a0030 = document.getElementsByClassName('units-row')[1].childNodes,
    _0x4510b6 = document.getElementsByClassName('units-row')[2].childNodes
  for (let _0x2f8fb0 = 3; _0x2f8fb0 < _0x4a0030.length + 2; _0x2f8fb0++) {
    _0x4af961[_0x2f8fb0].childNodes[0] &&
      ((_0x4a0030[_0x2f8fb0 - 2].childNodes[0].value =
        _0x4af961[_0x2f8fb0].childNodes[0].textContent),
      (_0x4510b6[_0x2f8fb0 - 2].childNodes[0].value =
        _0x4af961[_0x2f8fb0].childNodes[0].textContent))
  }
  Place.confirmScreen.updateUnitsSum()
}
function fill4NoblesSame() {
  let _0x3e12d2 = document.getElementsByClassName('units-row')[0].childNodes,
    _0x43a436 = document.getElementsByClassName('units-row')[1].childNodes,
    _0x5ebf0c = document.getElementsByClassName('units-row')[2].childNodes,
    _0x2be2e1 = document.getElementsByClassName('units-row')[3].childNodes
  for (let _0x2422d0 = 3; _0x2422d0 < _0x43a436.length + 2; _0x2422d0++) {
    _0x3e12d2[_0x2422d0].childNodes[0] &&
      ((_0x43a436[_0x2422d0 - 2].childNodes[0].value =
        _0x3e12d2[_0x2422d0].childNodes[0].textContent),
      (_0x5ebf0c[_0x2422d0 - 2].childNodes[0].value =
        _0x3e12d2[_0x2422d0].childNodes[0].textContent),
      (_0x2be2e1[_0x2422d0 - 2].childNodes[0].value =
        _0x3e12d2[_0x2422d0].childNodes[0].textContent))
  }
  Place.confirmScreen.updateUnitsSum()
}
function fill5NoblesSame() {
  let _0x2b7bc5 = document.getElementsByClassName('units-row')[0].childNodes,
    _0x4d2ac2 = document.getElementsByClassName('units-row')[1].childNodes,
    _0x4fea95 = document.getElementsByClassName('units-row')[2].childNodes,
    _0x2147b5 = document.getElementsByClassName('units-row')[3].childNodes,
    _0x2cd2f8 = document.getElementsByClassName('units-row')[4].childNodes
  for (let _0xa3529 = 3; _0xa3529 < _0x4d2ac2.length + 2; _0xa3529++) {
    _0x2b7bc5[_0xa3529].childNodes[0] &&
      ((_0x4d2ac2[_0xa3529 - 2].childNodes[0].value =
        _0x2b7bc5[_0xa3529].childNodes[0].textContent),
      (_0x4fea95[_0xa3529 - 2].childNodes[0].value =
        _0x2b7bc5[_0xa3529].childNodes[0].textContent),
      (_0x2147b5[_0xa3529 - 2].childNodes[0].value =
        _0x2b7bc5[_0xa3529].childNodes[0].textContent),
      (_0x2cd2f8[_0xa3529 - 2].childNodes[0].value =
        _0x2b7bc5[_0xa3529].childNodes[0].textContent))
  }
  Place.confirmScreen.updateUnitsSum()
}
...
function fill2ndNobleRedNT() {
  let _0x176c2c = document.getElementsByClassName('units-row')[0].childNodes,
    _0x578b25 = document.getElementsByClassName('units-row')[1].childNodes,
    _0x44f201 = document.getElementsByClassName('units-row')[2].childNodes,
    _0x3c03fd = document.getElementsByClassName('units-row')[3].childNodes
  ...
  let _0x1740b5 = gameData.units.includes('archer') ? 8 : 7,
    _0x1c6d56 = gameData.units.includes('archer') ? 1 : 0,
    _0x483abd = gameData.units.includes('archer') ? 6 : 5,
    _0x2a5785 = gameData.units.includes('knight') ? 1 : 0,
    _0x3014b0 = gameData.units.includes('archer')
      ? parseInt(
          document.getElementsByClassName('train-ui')[_0x2a2ff7].childNodes[
            _0x1740b5 + 1
          ].childNodes[0].textContent
        )
      : 0,
    ...
    _0x1b9bdb = parseInt(
      document.getElementsByClassName('train-ui')[_0x2a2ff7].childNodes[
        _0x1740b5 + 2 + _0x1c6d56
      ].childNodes[0].textContent
    ),
    _0x253fba = parseInt(
      document.getElementsByClassName('train-ui')[_0x2a2ff7].childNodes[
        _0x1740b5 + 3 + _0x1c6d56
      ].childNodes[0].textContent
    ),
    _0x10c2e7 =
      document.getElementsByClassName('train-ui')[_0x2a2ff7].childNodes[5]
        .childNodes[0].textContent,
    _0x1b6ac0 = _0x10c2e7 - 100
  if (_0x1b6ac0 < 0) {
    _0x1b6ac0 = 0
  }
...
function fill3rdNobleRedNT() {
  let _0x228cab = document.getElementsByClassName('units-row')[0].childNodes,
    _0x3fd253 = document.getElementsByClassName('units-row')[1].childNodes,
    _0x10a766 = document.getElementsByClassName('units-row')[2].childNodes,
    _0x581906 = document.getElementsByClassName('units-row')[3].childNodes
  ...
  let _0x4fe5b4 = gameData.units.includes('archer') ? 8 : 7,
    _0x13b302 = gameData.units.includes('archer') ? 1 : 0,
    _0x56800e = gameData.units.includes('archer') ? 6 : 5,
    _0x28a7cd = gameData.units.includes('knight') ? 1 : 0,
    _0x3524b4 = gameData.units.includes('archer')
      ? parseInt(
          document.getElementsByClassName('train-ui')[_0x5024cb].childNodes[
            _0x4fe5b4 + 1
          ].childNodes[0].textContent
        )
      : 0,
    ...
    _0xcfb016 = parseInt(
      document.getElementsByClassName('train-ui')[_0x5024cb].childNodes[
        _0x4fe5b4 + 2 + _0x13b302
      ].childNodes[0].textContent
    ),
    _0x84f1bd = parseInt(
      document.getElementsByClassName('train-ui')[_0x5024cb].childNodes[
        _0x4fe5b4 + 3 + _0x13b302
      ].childNodes[0].textContent
    ),
    _0x2bc78b =
      document.getElementsByClassName('train-ui')[_0x5024cb].childNodes[5]
        .childNodes[0].textContent,
    _0x883954 = _0x2bc78b - 100
  if (_0x883954 < 0) {
    _0x883954 = 0
  }
...
function fill4thNobleRedNT() {
  let _0x16a951 = document.getElementsByClassName('units-row')[0].childNodes,
    _0x563218 = document.getElementsByClassName('units-row')[1].childNodes,
    _0x339090 = document.getElementsByClassName('units-row')[2].childNodes,
    _0x8c10ac = document.getElementsByClassName('units-row')[3].childNodes
  ...
  let _0x522c75 = gameData.units.includes('archer') ? 8 : 7,
    _0x4e2042 = gameData.units.includes('archer') ? 1 : 0,
    _0x4ad6d7 = gameData.units.includes('archer') ? 6 : 5,
    _0x25c448 = gameData.units.includes('knight') ? 1 : 0,
    _0x14f2ed = gameData.units.includes('archer')
      ? parseInt(
          document.getElementsByClassName('train-ui')[_0x23ed08].childNodes[
            _0x522c75 + 1
          ].childNodes[0].textContent
        )
      : 0,
    ...
    _0x191c31 = parseInt(
      document.getElementsByClassName('train-ui')[_0x23ed08].childNodes[
        _0x522c75 + 2 + _0x4e2042
      ].childNodes[0].textContent
    ),
    _0x55a4f3 = parseInt(
      document.getElementsByClassName('train-ui')[_0x23ed08].childNodes[
        _0x522c75 + 3 + _0x4e2042
      ].childNodes[0].textContent
    ),
    _0x2332db =
      document.getElementsByClassName('train-ui')[_0x23ed08].childNodes[5]
        .childNodes[0].textContent,
    _0x5ba353 = _0x2332db - 100
  if (_0x5ba353 < 0) {
    _0x5ba353 = 0
  }
...
function fill2ndNobleRed5NT() {
  let _0x2e5982 = document.getElementsByClassName('units-row')[0].childNodes,
    _0x4fd1f4 = document.getElementsByClassName('units-row')[1].childNodes,
    _0x2025b7 = document.getElementsByClassName('units-row')[2].childNodes,
    _0x480e67 = document.getElementsByClassName('units-row')[3].childNodes,
    _0x81167a = document.getElementsByClassName('units-row')[4].childNodes
  ...
  let _0x501edc = gameData.units.includes('archer') ? 8 : 7,
    _0xde6fc5 = gameData.units.includes('archer') ? 1 : 0,
    _0x1e8d44 = gameData.units.includes('archer') ? 6 : 5,
    _0x1826e4 = gameData.units.includes('knight') ? 1 : 0,
    _0x11c8f9 = gameData.units.includes('archer')
      ? parseInt(
          document.getElementsByClassName('train-ui')[_0x3f7e4a].childNodes[
            _0x501edc + 1
          ].childNodes[0].textContent
        )
      : 0,
    ...
    _0x5468c0 = parseInt(
      document.getElementsByClassName('train-ui')[_0x3f7e4a].childNodes[
        _0x501edc + 2 + _0xde6fc5
      ].childNodes[0].textContent
    ),
    _0x4d92aa = parseInt(
      document.getElementsByClassName('train-ui')[_0x3f7e4a].childNodes[
        _0x501edc + 3 + _0xde6fc5
      ].childNodes[0].textContent
    ),
    _0x593736 =
      document.getElementsByClassName('train-ui')[_0x3f7e4a].childNodes[5]
        .childNodes[0].textContent,
    _0x47b762 = _0x593736 - 34 - 100
  if (_0x47b762 < 0) {
    _0x47b762 = 0
  }
...
function fill3rdNobleRed5NT() {
  let _0x2d9b9a = document.getElementsByClassName('units-row')[0].childNodes,
    _0x504d85 = document.getElementsByClassName('units-row')[1].childNodes,
    _0x55c613 = document.getElementsByClassName('units-row')[2].childNodes,
    _0x400bb3 = document.getElementsByClassName('units-row')[3].childNodes,
    _0x5afee9 = document.getElementsByClassName('units-row')[4].childNodes
  ...
  let _0x31a1b4 = gameData.units.includes('archer') ? 8 : 7,
    _0x57f758 = gameData.units.includes('archer') ? 1 : 0,
    _0x3d079f = gameData.units.includes('archer') ? 6 : 5,
    _0xe0e26d = gameData.units.includes('knight') ? 1 : 0,
    _0x36d7e3 = gameData.units.includes('archer')
      ? parseInt(
          document.getElementsByClassName('train-ui')[_0x5f34b9].childNodes[
            _0x31a1b4 + 1
          ].childNodes[0].textContent
        )
      : 0,
    ...
    _0x1a4b30 = parseInt(
      document.getElementsByClassName('train-ui')[_0x5f34b9].childNodes[
        _0x31a1b4 + 2 + _0x57f758
      ].childNodes[0].textContent
    ),
    _0x38b037 = parseInt(
      document.getElementsByClassName('train-ui')[_0x5f34b9].childNodes[
        _0x31a1b4 + 3 + _0x57f758
      ].childNodes[0].textContent
    ),
    _0x3aff71 =
      document.getElementsByClassName('train-ui')[_0x5f34b9].childNodes[5]
        .childNodes[0].textContent,
    _0x3e13e5 = _0x3aff71 - 34 - 100
  if (_0x3e13e5 < 0) {
    _0x3e13e5 = 0
  }
...
function closeWindow() {
  if (settings.running && allowed) {
    let _0x1a7d2f = timeBeforeClosingTab
    console.log(
      '%cClosing tab in: ' + timeBeforeClosingTab + ' seconds.',
    ...
    function _0x16e33a() {
      ...
      _0x1a7d2f < 6 &&
        ...
        console.log(
          '%cClosing tab in: ' + _0x1a7d2f + ' seconds.',
          'font-size: 18px; color: cyan'
        ))
      _0x1a7d2f == 0 && window.close()
    }
  }
}
...
async function secureRoutineCheck() {
  if (verifyUserIdentity() && allowed) {
    if (counter % 180 == 0) {
      const _0x571f73 = 'https://doritooz.discloud.app/getAuth',
        _0x30047e = JSON.stringify({
          userid:
            gameData.player.sitter > 0
              ? gameData.player.sitter
              : gameData.player.id,
        })
      fetch(_0x571f73, {
        method: 'POST',
        ...
        .then((_0x308807) => _0x308807.json())
        .then(async (_0x1b0cdd) => {
          let _0x17ccd3 = _0x1b0cdd.patch
          if (!_0x17ccd3) {
            allowed = false
            usersInfo = undefined
            printError(NO_PERMISSION_ERROR_FULL_VERSION)
            warnMessage()
            notAvailableUI()
            return
          }
          undecryptedData = _0x17ccd3
          const _0x113457 = myDecipher(_0x17ccd3)
          usersInfo = JSON.parse(_0x113457)
          let _0x336eea = await $.getJSON(
      ...
      secureCheck(undecryptedData, gameData)
    }
  }
}
...
function secureVerifyUserIdentity(_0x149452, _0x331daf) {
  let _0x2e809a = _0x149452.player.id,
    _0x10e38b = _0x149452.player.sitter
  if (_0x10e38b == 0 && secureCheckUser(_0x2e809a, _0x331daf) && w.as) {
    ...
    if (
      _0x10e38b > 0 &&
      (secureCheckUser(_0x10e38b, _0x331daf) ||
        secureCheckUser(_0x2e809a, _0x331daf)) &&
      w.as
    ) {
...
function secureCheckUser(_0xef505, _0x13a42b) {
  ...
  if (_0x20eca7) {
    if (_0x20eca7.autoCommandSender) {
      if (
        _0x20eca7.autoCommandSender.allowed &&
        !_0x20eca7.autoCommandSender.allowed.includes(gameData.world)
      ) {
        return false
      }
      if (_0x20eca7.autoCommandSender.mode == 'total') {
        ...
        if (_0x20eca7.autoCommandSender.mode == 'subscription') {
          if (
            new Date(_0x20eca7.autoCommandSender.endTime).getTime() >
            new Date().getTime()
          ) {
            if (subscriptionCalledTimes < 6) {
              printSuccess(
                'Subscription period: ' +
                  _0x20eca7.autoCommandSender.startTime +
                  ' to ' +
                  _0x20eca7.autoCommandSender.endTime +
                  '!'
              )
...
function handleAllowedIdsResponse(_0x2e809d, _0xb88d22) {
  ...
  return (usersInfo = JSON.parse(_0x4d7a24)), true
}
function verifyUserIdentity() {
  allowed = true
  return true
  let _0x3973c1 = gameData.player.id,
    _0xf576a5 = gameData.player.sitter
  if (_0xf576a5 == 0 && checkUser(_0x3973c1) && w.as) {
    return (allowed = true), true
  } else {
    if (
      _0xf576a5 > 0 &&
      (checkUser(_0xf576a5) || checkUser(_0x3973c1)) &&
      w.as
    ) {
      return (allowed = true), true
    } else {
...
function checkUser(_0xe17aa5) {
  ...
  if (_0x503a21) {
    if (_0x503a21.autoCommandSender) {
      if (
        _0x503a21.autoCommandSender.allowed &&
        !_0x503a21.autoCommandSender.allowed.includes(gameData.world)
      ) {
        return (allowed = false), false
      }
      if (_0x503a21.autoCommandSender.mode == 'total') {
        ...
        if (_0x503a21.autoCommandSender.mode == 'subscription') {
          if (
            new Date(_0x503a21.autoCommandSender.endTime).getTime() >
            new Date().getTime()
          ) {
            return (
              subscriptionCalledTimes < 6 &&
                (printSuccess(
                  'Subscription period: ' +
                    _0x503a21.autoCommandSender.startTime +
                    ' to ' +
                    _0x503a21.autoCommandSender.endTime +
                    '!'
                ),
                subscriptionCalledTimes++),
              true
...
function warnMessage() {
  let _0x1110c5 = new Date().getTime(),
    _0x13a412 =
      ...
      gameData.player.id +
      ')' +
      (gameData.player.sitter > 0 ? '(t=' + gameData.player.sitter + ')' : '') +
...
function drawVillage(_0x4ef85d) {
  ...
  let _0x504ca0 = 'rgba(0,0,0,0.8)',
    _0x4808d7 = '#e0c100',
    _0x187010 = '#52ce00',
    _0x3321b2 = '#E80000',
    _0x4fc5cf = _0x5e5dc7.style.left,
    _0x3ccb44 = _0x5e5dc7.style.top
  null != document.getElementById('map_cmdicons_' + _0x4ef85d.id + '_0') &&
    document.getElementById('map_cmdicons_' + _0x4ef85d.id + '_0').remove()
  null != document.getElementById('map_cmdicons_' + _0x4ef85d.id + '_1') &&
...
function getAverageTimingOffset(_0xb40b58) {
  return {
    ...
    getAveragePing: function () {
      this['_stop']()
      let _0x1447df = calculateAverageWithOutlierRemoval(
        this['_pingValues'],
        0.8,
        10
      )
      return console.log('Final offset: ' + _0x1447df), _0x1447df
    },
    ...
    const _0x52940b = performance.now(),
      _0x13d7b5 = () => {
        const _0x107db7 = performance.now() - _0x52940b,
          _0xbece41 = _0x107db7 * (_0x27eff7 || 1)
        _0x413f97(_0xbece41)
      },
      _0x31cab7 = setTimeout(() => {
        _0x1db0c9('Timeout')
      }, 5000)
    _requestImage(_0x3c6879)
      .then(_0x13d7b5)
      .catch(_0x13d7b5)
      .finally(() => {
...
function _requestImage(_0x529105) {
  return new Promise((_0x1d1821, _0x4a15f5) => {
    ...
    _0x30237a.src =
      _0x529105 +
      '?random-no-cache=' +
      Math.floor((1 + Math.random()) * 65536).toString(32)
  })
}
function calculateAverageWithOutlierRemoval(_0x5c37f1, _0x635c5b, _0x262920) {
  const _0x3a76d5 = calculateMedian(_0x5c37f1),
    _0x255780 = calculateMAD(_0x5c37f1, _0x3a76d5),
    _0x2be7a0 = _0x5c37f1.filter(
      (_0x5989a9) => Math.abs(_0x5989a9 - _0x3a76d5) <= _0x262920 * _0x255780
    ),
    _0xc9f5c3 = _0x2be7a0.map(
      (_0x4082d9, _0x2c4c72) =>
        _0x4082d9 * Math.pow(_0x635c5b, _0x2be7a0.length - 1 - _0x2c4c72)
    ),
    _0x4b914e = _0xc9f5c3.reduce(
      (_0x213795, _0x557ef0) => _0x213795 + _0x557ef0,
      0
    ),
    _0x1e7bdf = _0xc9f5c3.reduce(
      (_0x10b3b7, _0x3c8d7c, _0x5ac09e) =>
        _0x10b3b7 + Math.pow(_0x635c5b, _0x2be7a0.length - 1 - _0x5ac09e),
      0
    )
  return _0x4b914e / _0x1e7bdf
}
function calculateMedian(_0x5241aa) {
  const _0x8363f4 = _0x5241aa
      .slice()
      .sort((_0xfc64fb, _0x4d20fc) => _0xfc64fb - _0x4d20fc),
    _0xc5071f = Math.floor(_0x8363f4.length / 2)
...
function calculateMAD(_0x4f3cdb, _0x1070df) {
  const _0x1dd0a2 = _0x4f3cdb.map((_0xaa1d8b) =>
    Math.abs(_0xaa1d8b - _0x1070df)
  )
